			...
			<div class="well-shadow" style="margin-top:60px;">
				...
				<form class="form-horizontal" role="form">
					...
					<div class="form-group" style="margin-top:30px;">
						<div class=" col-sm-4">
							<a href="forgot.html" class="btn btn-primary" style="margin-left:0px;">Request another email</a>
						</div>
						<div class="col-sm-3" style="float:right;">
							<a href="signup1.html" class="btn btn-default" style="float:right;">Sign up</a>
						</div>
					</div>
				</form>
			</div>
